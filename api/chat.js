...
var SYSTEM_PROMPT = [
  ...
  "BUNDLES (on the Shop page, below the products):",
  ...
  "- The customer picks sizes and colours on the bundle card and presses Add Bundle to Cart there; the discount is applied automatically at checkout. You cannot add a bundle with the add_to_cart tool and the discount only applies when a bundle is added from the Shop page, so point people to the Shop page for bundles.",
  "",
