...
var SYSTEM_PROMPT = [
  ...
  "- The discount is applied automatically at checkout whenever all of a bundle's products are in the cart, with no code needed. The easiest way is the bundle card on the Shop page (pick sizes and colours, press Add Bundle to Cart), but adding the same products one by one gets the same discount. If two bundles overlap, the bigger discount applies to the shared items.",
  "",
